...
import { theWeightOfAnObjectImage } from '../../../portfolioData';
...
export const TheWeightOfAnObject = () => {
  ...
  const getImage = (id: any) => theWeightOfAnObjectImage.imageList?.filter(image => image.id === id)[0];

  return (
    <>
      <div className='header'>
        <h5>The Weight of an Object</h5>
      </div>
      <div className='image-container'>
        {
          theWeightOfAnObjectImage.imageList?.map((item: Image) => (
            <div key={item.id}>
