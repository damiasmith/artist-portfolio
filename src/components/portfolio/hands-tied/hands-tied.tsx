...
import { handsTiedImage } from '../../../portfolioData';
...
export const HandsTied = () => {
  ...
  const getImage = (id: any) => handsTiedImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          handsTiedImage.imageList?.map((item: Image) => (
            <div key={item.id}>
