...
import { burdensomeImage } from '../../../portfolioData';
...
export const Burdensome = () => {
  ...
  const getImage = (id: any) => burdensomeImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          burdensomeImage.imageList?.map((item: Image) => (
            <div key={item.id}>
