...
import { phalangealThelodontsImage } from '../../../portfolioData';
...
export const PhalangealThelodonts = () => {
  ...
  const getImage = (id: any) => phalangealThelodontsImage.imageList?.filter(image => image.id === id)[0];

  return (
    <>
      <div className='header'>
        <h5>Phalangeal Thelodonts</h5>
      </div>
      <div className='image-container'>
        {
          phalangealThelodontsImage.imageList?.map((item: Image) => (
            <div key={item.id}>
