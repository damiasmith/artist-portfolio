...
import { selfFulfillingProphecyImage } from '../../../portfolioData';
...
export const SelfFulfillingProphecy = () => {
  ...
  const getImage = (id: any) => selfFulfillingProphecyImage.imageList?.filter(image => image.id === id)[0];

  return (
    <>
      <div className='header'>
        <h5>Self-fulfilling Prophecy</h5>
      </div>
      <div className='image-container'>
        {
          selfFulfillingProphecyImage.imageList?.map((item: Image) => (
            <div key={item.id}>
