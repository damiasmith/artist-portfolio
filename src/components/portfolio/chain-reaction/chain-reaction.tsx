...
import { chainReactionImage } from '../../../portfolioData';
...
export const ChainReaction = () => {
  ...
  const getImage = (id: any) => chainReactionImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          chainReactionImage.imageList?.map((item: Image) => (
            <div key={item.id}>
