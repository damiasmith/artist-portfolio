...
import { expectationsImage } from '../../../portfolioData';
...
export const Expectations = () => {
  ...
  const getImage = (id: any) => expectationsImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          expectationsImage.imageList?.map((item: Image) => (
            <div key={item.id}>
