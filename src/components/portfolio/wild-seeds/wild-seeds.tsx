...
import { wildSeedsImage } from '../../../portfolioData';
...
export const WildSeeds = () => {
  ...
  const getImage = (id: any) => wildSeedsImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          wildSeedsImage.imageList?.map((item: Image) => (
            <div key={item.id}>
