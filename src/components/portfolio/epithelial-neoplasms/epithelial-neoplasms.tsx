...
import { epithelialNeoplasmsImage } from '../../../portfolioData';
...
export const EpithelialNeoplasms = () => {
  ...
  const getImage = (id: any) => epithelialNeoplasmsImage.imageList?.filter(image => image.id === id)[0];

  return (
    <>
      <div className='header'>
        <h5>Epithelial Neoplasms</h5>
      </div>
      <div className='image-container'>
        {
          epithelialNeoplasmsImage.imageList?.map((item: Image) => (
            <div key={item.id}>
