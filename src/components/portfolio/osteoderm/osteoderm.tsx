...
import { osteodermImage } from '../../../portfolioData';
...
export const Osteoderm = () => {
  ...
  const getImage = (id: any) => osteodermImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          osteodermImage.imageList?.map((item: Image) => (
            <div key={item.id}>
