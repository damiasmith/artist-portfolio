...
import { decorativeImage } from '../../../portfolioData';
...
export const Decorative = () => {
  ...
  const getImage = (id: any) => decorativeImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          decorativeImage.imageList?.map((item: Image) => (
            <div key={item.id}>
