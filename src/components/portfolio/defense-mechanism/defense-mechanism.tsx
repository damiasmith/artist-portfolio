...
import { defenseMechanismImage } from '../../../portfolioData';
...
export const DefenseMechanism = () => {
  ...
  const getImage = (id: any) => defenseMechanismImage.imageList?.filter(image => image.id === id)[0];

  return (
    <>
      <div className='header'>
        <h5>Defense Mechanism</h5>
      </div>
      <div className='image-container'>
        {
          defenseMechanismImage.imageList?.map((item: Image) => (
            <div key={item.id}>
