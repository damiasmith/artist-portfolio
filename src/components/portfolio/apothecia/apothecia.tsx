...
import { apotheciaImage } from '../../../portfolioData';
...
export const Apothecia = () => {
  ...
  const getImage = (id: any) => apotheciaImage.imageList?.filter(image => image.id === id)[0];
  ...
  return (
    <>
      ...
      <div className='image-container'>
        {
          apotheciaImage.imageList?.map((item: Image) => (
            <div key={item.id}>
